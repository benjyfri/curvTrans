...
def generate_surfaces_angles_and_sample(N, angle,min_len,max_len, upper_bound_y=None,upper_bound_x=None):
...
def sample_pyramid(n_points, gauss_curv, min_len,max_len, bias=0.0, r=None):
    if r is None:
